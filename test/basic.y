...
declaration
	...
	| declaration_specifiers init_declarator_list ';'   {if(char_check == 1){ary[3] += char_check2;}char_check=0;char_check2=0;if(int_check==1)ary[2] += int_check2;int_check2=0;int_check=0;}
	;
...
init_declarator
	: declarator    {if(char_check == 1){char_check2++;}if(int_check == 1){int_check2++;}}
	| declarator '=' initializer    {ary[1]++;if(char_check == 1){char_check2++;}if(int_check == 1){int_check2++;}}
	;
...
declarator
	: pointer direct_declarator {if(ptr_check==1)ary[4]++;ptr_check=0;}
	| direct_declarator 
	;
...
direct_declarator
	...
	| direct_declarator '(' parameter_type_list ')' {int_check =0;}
...
pointer
	: '*'	{ptr_check = 1;}
	| '*' type_qualifier_list	{ptr_check = 1;}
	| '*' pointer	{ptr_check = 1;}
	| '*' type_qualifier_list pointer	{ptr_check = 1;}
	;
...
parameter_declaration
	: declaration_specifiers declarator {if(int_check == 1)ary[2]++;int_check=0;}
