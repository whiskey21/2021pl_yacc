...
%token TYPEDEF EXTERN STATIC AUTO REGISTER NUMBER
...
postfix_expression
	...
	| postfix_expression '.' IDENTIFIER	{ary[1]++;printf("postfix1->postfix\n");}
	| postfix_expression PTR_OP IDENTIFIER	{ary[1]++;printf("postfix2->postfix\n");}
	| postfix_expression INC_OP	{ary[1]++;printf("postfix3-> postfix\n");}
	| postfix_expression DEC_OP	{ary[1]++;printf("postfix4->postfix\n");}
	;
...
unary_expression
	: postfix_expression
	| INC_OP unary_expression	{ary[1]++;printf("unary->unary");}
	| DEC_OP unary_expression	{ary[1]++;printf("unary->unary");}
...
cast_expression
	: unary_expression
	| '(' type_name ')' cast_expression	{ary[1]++;printf("cast_expression -> cast_expression");}
	;
...
assignment_operator
	: '='	{ary[1]++;printf("= -> assignment_operator\n");}
	| MUL_ASSIGN	{ary[1]++;}
	| DIV_ASSIGN	{ary[1]++;}
	| MOD_ASSIGN	{ary[1]++;}
	| ADD_ASSIGN	{ary[1]++;}
